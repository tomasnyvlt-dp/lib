...
})} />`}};const i={title:"Fields / CheckboxField",decorators:[s],component:t,argTypes:{label:{control:"text"},isDisabled:{control:"boolean"},textarea:{control:"boolean"},checkboxColor:{control:{type:"select",options:["green","white"]}},checkboxBorderColor:{control:{type:"select",options:["green","white","indigo2"]}},description:{control:"text"},labelCss:{control:"object"},onClick:{control:"object"},checkboxAlignTop:{control:"boolean"},withArrowDownIcon:{control:"boolean"},hiddenLabel:{control:"text"},hideField:{control:"boolean"},hideInRadioBoxContainer:{control:"boolean"},helper:{control:"text"},helperCss:{control:"object"},variant:{control:{type:"select",options:["sm","md","cart"]}},initialValue:{control:"boolean"},defaultValue:{control:"text"}},tags:["stories-mdx"],includeStories:["checkboxField"]};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:k};const T=["checkboxField"];export{T as __namedExportsOrder,r as checkboxField,i as default};
